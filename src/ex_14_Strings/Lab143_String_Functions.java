...
//        System.out.println(name.charAt(10)); // StringIndexOutOfBoundsException
        ...
        // 2. concat()
        System.out.println(name.concat(" Sagar"));
        ...
        String name4 = "Ranjnai@live.com@123";
        ...
        StringBuilder stringBuilder = new StringBuilder("Ranjani");
